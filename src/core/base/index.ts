...
import { tiangong_tracert } from "../../constant/index";
...
export default class Base {
    ...
    async sendEvent(
        ...
        const data = this._genEventData(target, utm_d, eventType, extra);
